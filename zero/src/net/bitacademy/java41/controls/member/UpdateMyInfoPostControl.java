...
@Component("/member/postupdateMyInfo.do")
public class UpdateMyInfoPostControl implements PageControl {
	
	MemberService memberService;
	
	public UpdateMyInfoPostControl setMemberService(MemberService memberService) {
	...
	public String execute(Map<String, Object> model) throws Exception {
		...
		Map<String,String[]> params = 
			...
			if(params.get("password")[0].equals(serverpwd)){
				...
				memberService.myInfochange(member);
